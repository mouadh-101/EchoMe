...
export default function SettingsPage() {
  ...
  const handlePasswordSave = async () => {
    ...
    try {
      await authService.updatePassword(passwordData.current, passwordData.new); // ✅ Wait for backend
              ...
              {!isEditingProfile && (
                <div className="grid grid-cols-2 gap-4 text-center">
                  <div className="bg-[#0E0E0E] rounded-xl p-4">
                    <p className="text-2xl font-bold text-[#1FB2A6]">154</p>
                    <p className="text-sm text-[#F4EBDC]/70">Total Echoes</p>
                  </div>
                  <div className="bg-[#0E0E0E] rounded-xl p-4">
                    <p className="text-2xl font-bold text-[#1FB2A6]">23</p>
                    <p className="text-sm text-[#F4EBDC]/70">Active Days</p>
                  </div>
                </div>
              )}
            </CardContent>
